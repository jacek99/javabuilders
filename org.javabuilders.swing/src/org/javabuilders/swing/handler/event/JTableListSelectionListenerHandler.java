 ...
 *
 */
public class JTableListSelectionListenerHandler extends AbstractPropertyHandler implements IPropertyList {
	...
	private static final JTableListSelectionListenerHandler singleton = new JTableListSelectionListenerHandler();

	/**
	 * @return Singleton
	 */
	public static JTableListSelectionListenerHandler getInstance() {return singleton;}

	
	/**
	 * @param consumedKeys
	 */
	public JTableListSelectionListenerHandler() {
		super(ON_SELECTION);
	}
